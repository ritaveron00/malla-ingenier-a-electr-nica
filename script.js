const materias = [
  ...
  { anio: "Segundo Año", nombre: "Algoritmos y Programación" },
  { anio: "Segundo Año", nombre: "Álgebra Lineal" },
  { anio: "Segundo Año", nombre: "Electricidad, Magnetismo y Calor" },
  { anio: "Segundo Año", nombre: "Introducción a los Dispositivos Electrónicos" },
  { anio: "Segundo Año", nombre: "Sistemas Digitales" },
  { anio: "Tercer Año", nombre: "Probabilidad y Estadística" },
  { anio: "Tercer Año", nombre: "Señales y Sistemas" },
  { anio: "Tercer Año", nombre: "Análisis de Circuitos" },
  { anio: "Tercer Año", nombre: "Redes de Comunicaciones" },
  { anio: "Tercer Año", nombre: "Planificación de Proyectos" },
  { anio: "Tercer Año", nombre: "Circuitos Microelectrónicos" },
  { anio: "Tercer Año", nombre: "Procesos Estocásticos" },
  { anio: "Tercer Año", nombre: "Control Automático" },
  { anio: "Tercer Año", nombre: "Taller de Sistemas Embebidos" },
  { anio: "Cuarto Año", nombre: "Química y Electroquímica" },
  { anio: "Cuarto Año", nombre: "Electromagnetismo Aplicado" },
  { anio: "Cuarto Año", nombre: "Taller de Automatización y Control" },
  { anio: "Cuarto Año", nombre: "Taller de Procesamiento de Señales" },
  { anio: "Cuarto Año", nombre: "Dispositivos Semiconductores" },
  { anio: "Cuarto Año", nombre: "Taller de Comunicaciones Digitales" },
  { anio: "Cuarto Año", nombre: "Taller de Diseño de Circuitos Electrónicos" },
  { anio: "Cuarto Año", nombre: "Higiene y Seguridad" },
  { anio: "Quinto Año", nombre: "Legislación y Ejercicio Profesional" },
  { anio: "Quinto Año", nombre: "Gestión de Proyectos Electrónicos" },
  { anio: "Quinto Año", nombre: "Trabajo Integrador Final de Ing. Electrónica (Trabajo Profesional/Tesis de Grado)" },
  { anio: "Quinto Año", nombre: "Impacto Social, Ambiental y Desarrollo Sustentable" },
  { anio: "Quinto Año", nombre: "Trabajo Integrador Final de Ing. Electrónica (Trabajo Profesional/Tesis de Grado)" } 
];
